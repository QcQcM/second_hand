<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateGood.aspx.cs" Inherits="second_hand.UI.updateGood" %>
                            ...
                            <tbody>
                                    ...
                                    <td width="37%">
                                        <div class="psssword item form-group">
                                            <div class="field" runat="server">
                                                <input class="title" type="text" placeholder="请输入商品标题" id="title" name="title" data-validate="required:同学，标题是必填内容哦" runat="server">
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td width="37%">
                                        <div class="psssword item form-group">
                                            <div class="field" runat="server">
                                                <input class="price" type="text" placeholder="请输入商品价格" name="price" id="price" data-validate="required:同学，价格是必填内容哦,plusinteger:金额只能为整数" runat="server"/>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="37%">
                                        <div class="psssword item form-group">
                                            <div class="field" runat="server">
                                                <input class="address" type="text" placeholder="请输入商品交易地点" name="address" id="address" data-validate="required:同学，交易地点是必填内容哦" runat="server" />
                                            </div>
                                        </div>
                                    </td>
                                </tr>               
                                ...
                                <tr>
                                    ...
                                    <td width="37%">
                                        <div class="psssword item form-group">
                                            <div class="field" runat="server">
                                                <input class="tel" type="text" placeholder="选填" name="tel" id="tel" value="" runat="server">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="37%">
                                        <div class="psssword item form-group">
                                            <div class="field" runat="server">
                                                <input class="new" type="text" name="new_level" id="new_level" runat="server">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="37%" colspan="2">
                                        <div class="psssword item form-group">
                                            <div class="field" runat="server">
                                                <textarea class="detail" type="text" placeholder="请输入商品详情" name="detail" id="detail" data-validate="required:同学，商品详情是必填内容哦" runat="server" ></textarea>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <asp:Button runat="server" ID="release_Button" Text="重新发布" BackColor="#00AA88" BorderStyle="None" ForeColor="White" OnClick="release_Button_Click" Height="31px" Width="101px" />              
                                 </div></td>
                                </tr>
                            </tbody>
                        </table>
